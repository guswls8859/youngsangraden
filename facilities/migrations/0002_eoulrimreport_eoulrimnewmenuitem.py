    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='eoulrim_reports', to=settings.AUTH_USER_MODEL, verbose_name='작성자')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='new_menu_items', to='facilities.eoulrimreport', verbose_name='보고서')),
            ],
            options={
                'verbose_name': '신메뉴 판매',
